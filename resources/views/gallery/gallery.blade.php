        ...
        <div class="margin">
            ...
            <div class="s-12 m-6 l-4">
                ...
                <div class="myContainer">
                    ...
                    <div class="middle">
                        <a class="button rounded-full-btn submit-btn margin-bottom" data-toggle="modal" data-target="#edit_gallery">
                            <img src="{{asset('tsai_bootstrap/img/ic_mode_edit_white_24dp_1x.png')}}">
                        </a>
                        <a class="button rounded-full-btn cancel-btn margin-bottom" data-toggle="modal" data-target="#delete_gallery">
